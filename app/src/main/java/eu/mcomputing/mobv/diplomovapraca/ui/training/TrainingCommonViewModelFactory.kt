...
import eu.mcomputing.mobv.diplomovapraca.data.repository.UserRepository // ⬅️ NOVÝ IMPORT
...
class TrainingCommonViewModelFactory(
    ...
    private val userRepository: UserRepository // ⬅️ NOVÁ ZÁVISLOSŤ
) : ViewModelProvider.Factory {

    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(TrainingCommonViewModel::class.java)) {
            // ⬇️ Vytvoríme inštanciu s odovzdaním všetkých štyroch závislostí ⬇️
